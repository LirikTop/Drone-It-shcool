    ...
    <div class="container-row">
        ...
        <div class="right">
            ...
            <p>
                ...
                dictum nunc faucibus eget eu. Morbi eu proin feugiat magna nam.
            </p>
            <div class="right-button">
                <button class="button button-1">Buy now</button>
                <button class="button button-2">More details</button>
            </div>
        </div>
    </div>
